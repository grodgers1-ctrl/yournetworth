...
export const tools: Tool[] = [
  {
    ...
    relatedTools: ["fire-number", "compound-interest", "mortgage-overpayment", "debt-payoff", "multi-currency-budget", "emergency-fund"],
  ...
  },
  {
    ...
    relatedTools: ["fire-number", "net-worth-tracker", "mortgage-overpayment", "debt-payoff", "multi-currency-budget", "emergency-fund"],
  ...
  },
  {
    ...
    relatedTools: ["mortgage-overpayment", "net-worth-tracker", "compound-interest", "emergency-fund"],
  ...
  },
  {
    ...
    relatedTools: ["net-worth-tracker", "compound-interest", "emergency-fund"],
  ...
  },
  {
    ...
    region: "uk",
    description: "Free emergency fund calculator for the UK. Work out how much cash you need, how long it will take to build, and track your progress towards a fully funded safety net.",
    pillarGuide: "emergency-fund",
    supportingArticles: ["emergency-fund-vs-premium-bonds"],
    relatedTools: ["debt-payoff", "multi-currency-budget", "compound-interest", "savings-goal"],
    methodology: "emergency-fund",
    authorSlug: "glenn-rodgers",
    reviewedBy: "glenn-rodgers",
    published: true,
  },
  {
    ...
    title: "Emergency Fund Calculator",
    region: "us",
    description: "Free emergency fund calculator for the US. Work out how much cash you need, how long it will take to build, and track your progress towards a fully funded safety net.",
    pillarGuide: "emergency-fund",
    supportingArticles: ["emergency-fund-vs-i-bonds"],
    relatedTools: ["debt-payoff", "multi-currency-budget", "compound-interest", "savings-goal"],
    methodology: "emergency-fund",
    authorSlug: "glenn-rodgers",
    reviewedBy: "glenn-rodgers",
...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    region: "uk",
    tool: "emergency-fund",
    description: "How much emergency fund you need in the UK, why three to six months is the usual rule, and where to keep the money so you can reach it quickly.",
    relatedArticles: ["emergency-fund-vs-premium-bonds"],
    relatedGuides: ["debt-payoff", "compound-interest", "net-worth-tracker"],
    authorSlug: "glenn-rodgers",
    reviewedBy: "glenn-rodgers",
    published: true,
  },
  {
    ...
    region: "us",
    tool: "emergency-fund",
    description: "How much emergency fund you need in the US, why three to six months is the usual rule, and where to keep the money so you can reach it quickly.",
    relatedArticles: ["emergency-fund-vs-i-bonds"],
    relatedGuides: ["debt-payoff", "compound-interest", "net-worth-tracker"],
    authorSlug: "glenn-rodgers",
    reviewedBy: "glenn-rodgers",
    published: true,
...
export const articles: Article[] = [
  ...
  {
    slug: "emergency-fund-vs-premium-bonds",
    title: "Emergency fund vs Premium Bonds: is your cash actually accessible?",
    region: "uk",
    guide: "emergency-fund",
    description: "Premium Bonds are popular in the UK, but they are not ideal for an emergency fund. Compare access, return, risk, and where to keep cash you may need quickly.",
    authorSlug: "glenn-rodgers",
    reviewedBy: "glenn-rodgers",
    published: true,
  },
  {
    slug: "emergency-fund-vs-i-bonds",
    title: "Emergency fund vs I Bonds: should any of it be inflation-linked?",
    region: "us",
    guide: "emergency-fund",
    description: "I Bonds protect US savers from inflation, but they have purchase limits and a 12-month lock-up. See how they compare to a high-yield savings account for emergency cash.",
    authorSlug: "glenn-rodgers",
    reviewedBy: "glenn-rodgers",
    published: true,
  },
...
export const methodologies: Methodology[] = [
  ...
  {
    slug: "emergency-fund",
    title: "Emergency Fund methodology",
...
Build it before you aggressively invest or overpay low-rate debt. Once it is in place, you can redirect the same monthly amount to longer-term goals.`,
    ...
    relatedTools: ["net-worth-tracker", "emergency-fund"],
  },
  {
    slug: "expense-ratio",
    title: "Expense ratio",
...
export const updates: Update[] = [
  ...
  {
    date: "2026-08-18",
    title: "Week 8: Emergency Fund calculator cluster live",
    body: "Added the Emergency Fund calculator for UK and US users, with live progress tracking, target-months scenarios, an embeddable version, plus region-specific pillar guides, supporting articles, and a methodology page.",
  },
];
