...
| Compounding frequency | n | Contribution frequency | k |
| --- | --- | --- | --- |
| Monthly | 12 | Weekly | 52 |
| Daily | 365 | Monthly | 12 |
| Annual | 1 | Quarterly | 4 |
| | | Annual | 1 |
...
<FAQ
  items={[
    ...
    {
      question: "What contribution frequencies are supported?",
      answer: "Weekly (k=52), monthly (k=12), quarterly (k=4), and annual (k=1).",
    },
    {
      question: "What happens when compounding and contribution frequencies differ?",
      answer: "The annual rate is converted to an effective rate per contribution period using r_eff = (1 + r/n)^(n/k) - 1, then the standard annuity formula is applied with k periods per year.",
    },
    {
      question: "When are contributions added?",
      answer: "At the end of each contribution period. A contribution does not earn interest in the period it is paid.",
    },
    {
