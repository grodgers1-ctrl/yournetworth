...
For each strategy, the tool reports the months to debt-free, the total interest paid, the payoff order, and a month-by-month series of the total remaining balance. The two series are rendered as overlaid curves so you can see where the strategies diverge and by how much.
