...
Add sinking funds as separate Cash accounts with the + Savings pot chip — one pot each for holidays, Christmas, or your emergency fund. Switch between Standard and Freedom Framework modes at any time. Your inputs stay in your browser, and you can export them as JSON or CSV.
