...
<FAQ
  items={[
    ...
    },
    {
      ...
      answer: "Yes, but also include the mortgage balance. In the Freedom Framework, a primary residence is usually treated as a Valuable Liability because it has value but also costs money to keep.",
    },
    {
