...
£500 a month is £6,000 a year. That is well inside the current £20,000 annual ISA allowance, so a single ISA could hold the whole example. The same math applies to a SIPP, but the money is normally locked until the normal minimum access age, which is currently 55 for some people and rises to 57 from 2028 for those born on or after 6 April 1973. HMRC sets the rules and allowances for both ISAs and SIPPs.
...
<FAQ
  items={[
    ...
    },
    {
      ...
      answer: "No, the math works in any account. But an ISA removes tax drag on income and gains, so more of the growth stays in the pot. A SIPP works similarly but is locked until the normal minimum access age.",
    },
    {
