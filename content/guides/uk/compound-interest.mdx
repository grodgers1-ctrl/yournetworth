...
In the UK, the wrapper you choose changes the tax result but not the underlying maths. A Stocks and Shares ISA grows free of income tax and capital gains tax. A SIPP gives tax relief on the way in but is taxed as income on the way out. A General Investment Account has no tax wrapper. The formula applies to all of them. HMRC and the Bank of England set the wider context for savings rates, inflation, and tax policy.
...
The concept is explained by the SEC at [Investor.gov](https://www.investor.gov/financial-tools-calculators/calculators/compound-interest-calculator) and in UK context by HMRC and Bank of England guidance on savings, inflation, and tax wrappers.
...
Daily and monthly are almost identical for most practical purposes. Monthly is the default because most UK savers and investors contribute monthly.
...
For example, if your ISA is expected to return 7% a year, your money doubles roughly every 10 years. Over 30 years, that is about three doublings. £10,000 becomes £20,000, then £40,000, then £80,000. This is why starting early matters so much. A 25-year-old who invests £10,000 could see three doublings before retirement. A 45-year-old who invests the same amount may see only one and a half.
...
This is good news for most people. You cannot control the market, but you can control how much you save. The best strategy is usually to set a steady contribution that you can keep up for decades, inside a tax wrapper, and accept that the return will vary.

## A UK worked example inside an ISA

Here is a realistic example: £10,000 already in a Stocks and Shares ISA, plus £500 added every month, earning 7% a year before fees and taxes, with monthly compounding. The ISA means growth is not reduced by dividend tax or capital gains tax.
...
£500 a month is £6,000 a year. That is well inside the current £20,000 annual ISA allowance, so a single ISA could hold the whole example. The same maths applies to a SIPP, but the money is normally locked until the normal minimum access age, which is currently 55 for some people and rises to 57 from 2028 for those born on or after 6 April 1973. HMRC sets the rules and allowances for both ISAs and SIPPs.
...
The difference becomes enormous over long periods. Here is the same example from the ISA section, but comparing compound interest against simple interest on the same principal and contributions.
...
The simple interest calculation assumes that each monthly contribution earns a fixed 7% of the remaining years, but the interest itself does not earn further interest. The compound interest line is the real-world effect of an investment that compounds monthly. Over 40 years, the difference is more than £860,000.
...
The maths works on any amount. £50 a month is enough to see the effect. The key is to start and to keep going.
...
They matter a lot. A 1% annual fee reduces the final balance more than most people expect. An ISA removes tax drag for UK investors, which is why the wrapper is important even though the formula is the same.
...
Open the [UK compound interest calculator](/uk/tools/compound-interest/). You can use it to answer several questions.
...
For retirement planning, use the result alongside the [FIRE number guide](/uk/guides/fire-number/). For tracking the balance you are building, use the [net worth tracker guide](/uk/guides/net-worth-tracker/). The compound interest calculator tells you where a single stream of contributions is heading. The net worth tracker tells you where you actually are.

The formula is documented by the SEC at [Investor.gov](https://www.investor.gov/financial-tools-calculators/calculators/compound-interest-calculator) and by HMRC and the Bank of England in the UK context.
  ...
  items={[
    {
      ...
      answer: "It is earning growth on your previous growth. The balance gets bigger each period, so the same percentage rate produces a larger pound gain over time.",
    },
    {
    ...
    {
      question: "Do I need a Stocks and Shares ISA to benefit from compound interest?",
      answer: "No, the maths works in any account. But an ISA removes tax drag on income and gains, so more of the growth stays in the pot. A SIPP works similarly but is locked until the normal minimum access age.",
    },
    {
      question: "What is a realistic return rate for UK investors?",
      answer: "A diversified global equity portfolio is often projected at 5-7% a year before fees and inflation. The FTSE 100 has historically produced a higher dividend yield but lower capital growth than the US market. Real returns vary year to year.",
    },
    {
