...
Before your first snapshot, do some detective work. Many people have forgotten workplace pensions from old jobs. The government's free [Pension Tracing Service](https://www.gov.uk/find-pension-contact-details) can find them, and a found pension can add thousands to your net worth.

You can add sinking funds as separate Cash accounts with the + Savings pot chip — one pot each for Christmas, holidays, or your emergency fund. You can switch between Standard mode and Freedom Framework mode at any time. Your inputs stay in your browser and you can export them as JSON or CSV.
