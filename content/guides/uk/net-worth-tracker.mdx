...
You can add sinking funds as separate Cash accounts. You can switch between Standard mode and Freedom Framework mode at any time. Your inputs stay in your browser and you can export them as JSON or CSV.
